...
export interface FightRequest {
    /**
     * @generated from protobuf field: int32 id1 = 1;
     */
    id1: number;
    /**
...
export interface FightResponse {
    /**
     * @generated from protobuf field: hero.v1alpha.Hero hero1 = 1;
     */
    hero1?: Hero;
    /**
     * @generated from protobuf field: hero.v1alpha.Hero hero2 = 2;
     */
    hero2?: Hero;
}
...
class FightRequest$Type extends MessageType<FightRequest> {
    ...
    internalBinaryWrite(message: FightRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 id1 = 1; */
        if (message.id1 !== 0)
            writer.tag(1, WireType.Varint).int32(message.id1);
        /* int32 id2 = 2; */
        if (message.id2 !== 0)
...
class FightResponse$Type extends MessageType<FightResponse> {
    constructor() {
        super("hero.v1alpha.FightResponse", [
            { no: 1, name: "hero1", kind: "message", T: () => Hero },
            { no: 2, name: "hero2", kind: "message", T: () => Hero }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FightResponse): FightResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* hero.v1alpha.Hero hero1 */ 1:
                    message.hero1 = Hero.internalBinaryRead(reader, reader.uint32(), options, message.hero1);
                    break;
                case /* hero.v1alpha.Hero hero2 */ 2:
                    message.hero2 = Hero.internalBinaryRead(reader, reader.uint32(), options, message.hero2);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: FightResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* hero.v1alpha.Hero hero1 = 1; */
        if (message.hero1)
            Hero.internalBinaryWrite(message.hero1, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* hero.v1alpha.Hero hero2 = 2; */
        if (message.hero2)
            Hero.internalBinaryWrite(message.hero2, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
